...
VarName_all_format = ["Timestamp", "num_ues", "IMSI", "RNTI",...
    ...
    "MCS", "dl_n_samples", "dl\_bufferbytes", "Throughput [Mbps]", "tx_pktsDownlink", "tx_errorsDownlink", "CQI", ...
    "ul_mcs", "ul_n_samples", "ul\_bufferbytes", ...
...
%         table = importfile(fullfile(filenames(i).folder,filenames(i).name));
